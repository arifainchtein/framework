...
public class CajalJSSCWriter  extends BufferedWriter{

		CajalJSSCReader aCajalReader;
		Logger logger;
		Writer output;
		long lastCommandTime=0;
		long minimumIntervalBetweenCommands=2000;
		
		public CajalJSSCWriter(Writer out, CajalJSSCReader c) {
			super(out);
			aCajalReader=c;
			output=out;
		...
		public CajalJSSCReader getReader() {
			return aCajalReader;
		}
