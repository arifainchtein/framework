...
public class AnnabelleDeserializerFactory extends Object {

			
    public AnnabelleDeserializerFactory() {
    }
     ...
     */
    public static AnnabelleDeserializer createAnnabellDeserializer(String className) throws ServletProcessingException{ 
           
        boolean objectCreated = false;       
        AnnabelleDeserializer aAnnabellDeserializer = null;
        ...
        try {
            ...
            for ( int i=0; i < constructors.length; i++ ) {
                ...
                if (parameterTypes.length == 0){
                    Object[] anArray = { };
                    aAnnabellDeserializer = (AnnabelleDeserializer) constructors[i].newInstance(anArray);
                    objectCreated = true;
                    break;
                }    
            }    
