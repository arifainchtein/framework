...
public final class EquipmentSystemOfUnits extends SystemOfUnits{

private EquipmentSystemOfUnits(){
}

	private static HashSet<Unit<?>> INSTANCES = new HashSet<Unit<?>>();
	private static final EquipmentSystemOfUnits INSTANCE = new EquipmentSystemOfUnits();
	
	/**
     * Energy Density is a measure of energy per unit of volume 
     */
    public static final BaseUnit<Dimensionless> NUMBER_UNITS = new BaseUnit<Dimensionless>("Units");
    /////////////////////
	// Collection View //
	/////////////////////
	...
	public static EquipmentSystemOfUnits getInstance(){
		return INSTANCE;
	}
	@Override
